...
%tag3(35 5)    被追踪的目标tag4（tag_x,tag_y） 范围-35
clear all
reader_x=[0 -40 40];% 信号接收端横坐标 
reader_y=[70 0 0];%纵坐标
tag_x=[5 -35 35 30];%参考点坐标           %%%%%%%%%%%%%%%%%%修改tracked tags 第四个中tag_x tag_y值
tag_y=[65 5 5 22];
...
Ni=4;
PI=3.1415926;
matrix(3,4,20)=1;  %定义三维数据组 matrix(a,b,:)  reader_a接收到reader_b的信号窗口中的随机变量
dist(3,4)=1;        %定义距离数组
