...
%         UN1(i,2)=(PA1(i,2)/dist1(i,1)+PB1(i,2)/dist1(i,2)+PC1(i,2)/dist1(i,3)+PD1(i,2)/dist1(i,4))/(1/dist1(i,1)+1/dist1(i,2)+1/dist1(i,3)+1/dist1(i,4));    
        UN1(i,1)=(PA1(i,1)/dist1(i,1)+PB1(i,1)/dist1(i,2)+PC1(i,1)/dist1(i,3)+PD1(i,1)/dist1(i,4))/4;
        UN1(i,2)=(PA1(i,2)/dist1(i,1)+PB1(i,2)/dist1(i,2)+PC1(i,2)/dist1(i,3)+PD1(i,2)/dist1(i,4))/4;
    end
    r=r+1;
 end
